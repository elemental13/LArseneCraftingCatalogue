...
public class InventoryModel(ILogger<InventoryModel> logger, CraftingContext db) : PageModel
{
    private readonly ILogger<InventoryModel> _logger = logger;
    private readonly CraftingContext _db = db;

    public List<Armor> GetInventoryList()
    {
